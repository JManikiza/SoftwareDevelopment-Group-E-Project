...
var widthFromProps = lib.spacing.withWidth({
  noDefault: true
});
var desktopWidthFromProps = lib.spacing.withWidth({
...
var GridCol = styled__default["default"]('div').withConfig({
  ...
  if (!widthStyle) {
    ...
    widthStyle = _defineProperty({}, constants.MEDIA_QUERIES.TABLET, {
      width: widthValue
    });
  }
