...
var StyledHeading = styled__default["default"]('h1').withConfig({
...
})(lib.typography.textColour, function (_ref) {
  var size = _ref.size;
  var actualSize = Number.isNaN(Number(size)) ? constants.HEADING_SIZES[size] : size;

  if (!actualSize) {
    throw Error("Unknown size ".concat(size, " used for heading."));
  }

  return _objectSpread2({}, lib.typography.font({
    size: actualSize,
    weight: 'bold'
  }));
}, {
  ...
  var size = _ref2.size;
  var actualSize = Number.isNaN(Number(size)) ? constants.HEADING_SIZES[size] : size;
  var scaleInfo = constants.TYPOGRAPHY_SCALE[actualSize];
...
var H1 = function H1(props) {
  return /*#__PURE__*/React__namespace.createElement(Heading, _extends({
    as: "h1",
